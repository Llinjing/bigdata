...
public class CheckKeyExists {
	...
	public static void usage() {
		System.out.println("CheckKeyExists <key_file> <acs_server> <acs_port>");
	}
	
	public static void query(AcsClient client, List<String> list) {
		List<Status> status_list = client.existMul(SysType.USER_READ, list, 2000);
		if (status_list != null) {
