 ...
 object StatUserImpression {
   ...
   def impression(impressionInput: String, sc: SparkContext, br: Broadcast[Map[String, String]]): RDD[(String, ((Long, Long), (Long, Long), (Long, Long)))] = {
     ...
     val outputRdd = impressionRdd.map(x => (x._1, ((0L, 0L), x._2, (0L, 0L))))
     outputRdd
   }
