 ...
 object StatUserClick {
   ...
   def click(clickInput: String, sc: SparkContext, br: Broadcast[Map[String, String]]): RDD[(String, ((Long, Long), (Long, Long), (Long, Long)))] = {
     ...
     val outputRdd = clickRdd.map(x => (x._1, ((0L, 0L), (0L, 0L), x._2)))
     outputRdd
   }
