...
object StatUserLTV {
  ...
  def statThirtyLTV(str_accumulation: String, str_newuser: String, sc: SparkContext) ={
    ...
    val rdd_thirty_ltv = rdd_accu.join(rdd_new).map(x=>{
      ...
      (s"$uid$KEY_TAG$dimention2$KEY_TAG$content_type$KEY_TAG$platform", values)
  ...
  def statMergeLTV(str_before: String, before_thirtyday_newuser: String, ystd_imp: String, ystd_click: String, ystd_list_dwelltime: String, ystd_detail_dwelltime: String, str_output: String, sc: SparkContext) ={
    ...
    val rdd_ltv_result = rdd_thirty_ltv.union(rdd_tail_ltv).reduceByKey((a, b)=>(a._1 + b._1, a._2 + b._2, a._3 + b._3, a._4 + b._4)).map(x=>{
      val info = x._1.split(KEY_TAG)
      val (uid, key) = (info.head, info.tail.mkString(KEY_TAG))
      (key,(1L,x._2))
    }
    ).reduceByKey((a,b)=>(a._1 + b._1,(a._2._1 + b._2._1, a._2._2 + b._2._2, a._2._3 + b._2._3, a._2._4 + b._2._4)))
