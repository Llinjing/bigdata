...
object StatUserImpressionAll {
  ...
  def impression(impressionInput: String, clickInput: String, sc: SparkContext, br: Broadcast[Array[String]]): RDD[(String, ((Long, Long), (Long, Long), (Long, Long), (Long, Long), (Long, Long)))] = {
