...
APP_NAME=article-feedback-10min-json
...
spark-submit --master yarn-cluster \
	...
	--class com.inveno.news.nearline.feedback.ArticleFeedback ${LOCAL_LIB_PATH}/nearline-feedback.jar \
	${APP_NAME} 10 1 \
	${APP_NAME} \
	${CHECKPOINT_DIR}
