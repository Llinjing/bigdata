...
APP_NAME=user-feedback-10min-json
...
spark-submit --master yarn-cluster \
	...
	--conf "spark.driver.extraJavaOptions=-XX:+UseParNewGC -Xms4096m -Xmx4096m -XX:+UseConcMarkSweepGC -Xms4096m -Xmx4096m -XX:MaxPermSize=512M -XX:+PrintGCDetails -verbose:gc -XX:+PrintGCTimeStamps" \
