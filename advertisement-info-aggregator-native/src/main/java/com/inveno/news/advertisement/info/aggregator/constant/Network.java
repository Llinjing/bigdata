...
public class Network {
    public static class NetworkValue {
        ...
        public static final NetworkValue ALL = new NetworkValue(0);

        public static final NetworkValue WIFI = new NetworkValue(1);

        public static final NetworkValue NETWORK_2G = new NetworkValue(4);

        public static final NetworkValue NETWORK_3G = new NetworkValue(3);

        public static final NetworkValue NETWORK_4G = new NetworkValue(2);
    ...
    public static class NetworkValueDesc {
        ...
        public static final NetworkValueDesc ALL = new NetworkValueDesc("all");
    ...
    static {
        ...
        network_value_desc.put(NetworkValue.ALL.getValue(), NetworkValueDesc.ALL.toString());
    ...
    public static String getNetwork(String network_str) {
        int network = Network.NetworkValue.UNKNOWN.getValue();
        try {
