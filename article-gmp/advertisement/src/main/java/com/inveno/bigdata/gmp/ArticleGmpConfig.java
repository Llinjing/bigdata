...
public class ArticleGmpConfig {
	...
	private boolean isValid() {
		return (!StringUtil.isEmpty(config.getString("config.type")) &&
				...
				!StringUtil.isEmpty(config.getString("redis.key.prefix")) &&
				!StringUtil.isEmpty(config.getString("redis.key.ttl")) &&
				!StringUtil.isEmpty(config.getString("redis.key.partitions")) &&
