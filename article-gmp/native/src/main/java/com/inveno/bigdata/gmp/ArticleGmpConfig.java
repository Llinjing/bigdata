...
public class ArticleGmpConfig {
	...
	private ArticleGmpConfig() {
		try {
			...
			prop.load(this.getClass().getResourceAsStream("/article-gmp.properties"));
	...
	private boolean isValid() {
		return (!StringUtil.isEmpty(config.getString("config.type")) &&
				...
				!StringUtil.isEmpty(config.getString("topic.request")) &&
				...
				!StringUtil.isEmpty(config.getString("topic.request.partition")) &&
				...
				!StringUtil.isEmpty(config.getString("hdfs.request")) &&
				...
				!StringUtil.isEmpty(config.getString("product_id_meizu")) &&
				!StringUtil.isEmpty(config.getString("product_id_ali")) &&
